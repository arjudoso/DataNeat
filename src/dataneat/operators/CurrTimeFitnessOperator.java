...
public class CurrTimeFitnessOperator extends BaseNeat implements TargetFitnessOperator {
	...
	public CurrTimeFitnessOperator(PropertiesHolder p, INDArray stabilMatrix) {
		super(p);
		stabil = stabilMatrix;
